...
def def_regions(k_1, k):
	...
	global r_1_k
	for k1 in np.arange(r_1_k_1.extrema[0][0], r_1_k_1.extrema[1][0] + 1):
		r_1_k_min.append(k1/2)
		r_1_k_max.append((((1-xi1_d)*k_j - (2-xi1_d)*k_c) * k1)/(2*k_c))
	global r_2_k_1
