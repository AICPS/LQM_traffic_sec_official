...
pi1_arr=[0.5]; % the initial green time ratios
pi2_arr=[0.5];
...
pi1d_arr=[0.4, 0.3, 0.2]; % array of green time ratios during attack window
pi2d_arr =[0.6, 0.7, 0.8]; 

init_states = cat(1, [4,8], [8,8]); % 4,8 or 2,6
